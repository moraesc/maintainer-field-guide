...
Welcome to the **Field Guide** — the definitive (and entirely fictional) naturalist's companion to the creatures that inhabit open source repositories. Compiled from decades of field observations by maintainers who've seen things. Strange things. In their notification inboxes.
...
2. [Species Index](#-species-index)
3. [Habitat Map](#-habitat-map)
...
|---|---|---|---|
| [The Drive-By Typo Fixer](species/the-drive-by-typo-fixer.md) | Abundant | README files | 🟢 Harmless |
| [The Issue Novelist](species/the-issue-novelist.md) | Common | Issue trackers | 🟡 Moderate |
| [The Silent Star-Gazer](species/the-silent-star-gazer.md) | Ubiquitous | Repository pages | 🟢 Harmless |
| [The Scope Creeper](species/the-scope-creeper.md) | Common | Pull requests | 🔴 High |
| [The Phantom Closer](species/the-phantom-closer.md) | Rare | Stale issues | 🟡 Moderate |
...
| ☀️ Summer | Intern season | Issue Novelists emerge in large numbers |
| 🍂 Autumn | Hacktoberfest | All species converge; ecosystem stress peaks |
...
Essential guidance for maintainers navigating the wild. See [survival-tips.md](survival-tips.md) for the full guide.
...
See [glossary.md](glossary.md) for the complete lexicon of open source terminology, from "LGTM" to "bikeshedding" to "yak shaving."
...
- Follow the [species template](species/TEMPLATE.md)

---

*Published by the Society for the Preservation of Maintainer Sanity*

*Field Edition — Maintainer Summit 2026*
